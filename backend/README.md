...
## Project Structure
    ...
    ├── testapiautoconnect_103816  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_103816`
...
2. Clone this repo and `cd testapiautoconnect_103816`
